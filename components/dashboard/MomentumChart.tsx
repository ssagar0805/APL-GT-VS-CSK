...
export function MomentumChart() {
  ...
  if (loading) {
    return (
      <Card className="col-span-1 md:col-span-2 overflow-hidden border-white/10 bg-white/[0.03] rounded-2xl flex flex-col h-[380px] justify-center items-center">
  ...
  return (
    <Card className="col-span-1 md:col-span-2 overflow-hidden border-white/10 bg-white/[0.03] rounded-2xl flex flex-col h-[380px]">
